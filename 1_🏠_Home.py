...
def ask_bot(input_text):
    ...
    PROMPT_QUESTION = """
        Your name is IBM Skills Network, helping humans to get answers about you. Briefly introduce yourself first if it's your first time talking with this human.
