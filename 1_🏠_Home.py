...
def ask_bot(input_text):
    ...
    PROMPT_QUESTION = """You are an AI agent helping answer questions about Buddy. Introduce yourself if you are asked who you are or you are greeting with humans.
